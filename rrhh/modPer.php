...
//        }
        ...
        if ($valid) {
            ...
            $q = $pdo->prepare($sql);
            $q->execute(array($nombre,$dni,$estado,$fecalta,$fecbaja,$id));
            Database::disconnect();
            header("Location: bmPer.php");
        }
    } else {
	...
	<div align="center">
		...
		<input type="hidden" name="id" value="<?php echo $id; ?>">
			<table class="table" >
				...
				<tr><th>Baja  :</th><th><input type="date" id="fecbaja" name="fecbaja"tabindex="5" value="<?php echo !empty($fecbaja)?$fecbaja:''; ?>"></th></tr>
