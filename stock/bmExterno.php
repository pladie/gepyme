...
<body class="body">
    <div align="left" class="volver">
	  ...
	  <div align="center">
		    <p class="title"><strong>Modificaion de bien externo</strong></p>
     	  <table class="tableli">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                    ...
                    $sql = 'SELECT * FROM stockExternos WHERE stktipo = "Redes" and stkasignacion = "STOCK" AND stkestado NOT IN ("BAJA") ORDER BY stkmarca,stkmodelo';      
