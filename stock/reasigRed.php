...
<body class="body">
    <div align="center">
            <p class="title"><strong>Reasignacion de dispositivo de Red</strong>>
            <div class="row">
                <table class="tableli">
                  <thead>
                    <tr>
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM stock WHERE stktipo = "Redes" and stkasignacion NOT IN ("STOCK","BAJA") ORDER BY stkmarca,stkmodelo';      
