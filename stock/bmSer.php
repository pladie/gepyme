            ...
            <div class="row">
                <table class="table">
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM stock WHERE stktipo = "Servidor" and stkasignacion = "STOCK" ORDER BY stkmarca,stkmodelo';      
                   foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<img alt="" src="../img/eye.png" width="15" height="15"></a>';
        							 echo '</td> ';
        							 echo '<td align="center">';
                            echo '<a href="modSer.php?id='.$row['iduser'].'">';
