...
<div align="left" class="volver">
    ...
    <div align="center">
            <p class="title"><strong>Reasignacion de Bien</strong>
            <div class="row">
                <table class="tableli">
                  <thead>
                    <tr>
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM stockExternos WHERE stktipo = "Redes" and stkasignacion NOT IN ("STOCK","BAJA") ORDER BY stkmarca,stkmodelo';      
