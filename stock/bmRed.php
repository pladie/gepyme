...
<body class="body">
    <div align="center">
            <div class="row">
                <h3>Modificaion de dispositivo de Red</h3>
            </div>
            <div class="row">
                <table class="table">
                  <thead>
                    <tr>
                      <th>Marca</th><th>Modelo</th><th>Serie</th><th>Asignacion</th><th>Detalle</th><th>Asignar</th><th>Comprobante</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                   ...
                   $sql = 'SELECT * FROM stock WHERE stktipo = "Red" and stkasignacion = "STOCK" ORDER BY stkmarca,stkmodelo';      
                   foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<img alt="" src="../img/eye.png" width="15" height="15"></a>';
        							 echo '</td> ';
        							 echo '<td align="center">';
                            echo '<a href="modRed.php?id='.$row['iduser'].'">';
