...
<body class="body">
	...
	<div align="center">
		<p class="title"><strong>Modificaion de dispositivo de Red</strong></p>
     	<table class="tableli">
                  <thead>
                    <tr>
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM stock WHERE stktipo = "Redes" and stkasignacion = "STOCK" AND stkestado NOT IN ("BAJA") ORDER BY stkmarca,stkmodelo';      
