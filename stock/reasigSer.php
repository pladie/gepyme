...
<div align="left" class="volver">
    ...
    <div align="center">
            <p class="title"><strong>Reasignacion de Servidor</strong>
            <div class="row">
                <table class="tableli">
                  <thead>
                    <tr>
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM stock WHERE stktipo = "Servidor" and stkasignacion NOT IN ("STOCK","BAJA") ORDER BY stkmarca,stkmodelo';      
