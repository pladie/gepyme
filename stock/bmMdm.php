...
<body class="body">
	...
	<div align="center">
		<p class="title"><strong>Modificaion de Modems</strong></p>
     	<table class="tableli">
         <thead>
         ...
         <tbody>
            <?php
               ...
               $sql = 'SELECT * FROM stock WHERE stktipo = "Modem" and stkasignacion = "STOCK" AND stkestado NOT IN ("BAJA") ORDER BY stkmarca,stkmodelo';      
