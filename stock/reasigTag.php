...
<body class="body">
  <div align="left" class="volver">
    ...
    <div align="center">
            <p class="title"><strong>Reasignacion de Dispositivo</strong>
            <div class="row">
                <table class="tableli">
                  <thead>
                    <tr>
                      <th>Modelo</th><th>Serie</th><th>Asignacion</th><th>Detalle</th><th>Editar</th><th>Comprobante</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                   ...
                   $sql = 'SELECT * FROM stock WHERE stktipo = "Tag" and stkasignacion NOT IN ("STOCK","BAJA") ORDER BY stkmodelo';
